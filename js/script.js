...
<div class="col-auto topheadLinks">
    <a target="_blank" href="tel:yourNumber"><i class="fa-solid fa-phone" aria-hidden="true"></i> YourNumber</a>
    <a target="_blank" href="mailto:Yor@Email.com"><i class="fa-solid fa-envelope"></i> Yor@Email.com</a>
  </div>
  <div class="col-auto topheadSocial">
    ...
    <a target="_blank" href="https://in.linkedin.com/"><i class="fa-brands fa-linkedin"></i></a>
    </div>
</div>
            </div>
            </div>
        <div id="main-header">
            ...
            <div class="container header">
                ...
                <ul class="navMenu ms-auto mb-2 mb-lg-0">
                  ...
                  <li class="navLi"><a class="navLink" href="aboutUs.html">About</a></li>
                  
                  <li class="navLi">
                  <a href="#" class="navLink">Programs & Plans
        ...
        <div class="footWrap defaultPadding">
          ...
          <!-- Company Info -->
            <div class="col-lg-auto col-sm-6 mb-4 mb-md-0 FooterAbout">
              ...
              <p>
              Empower Coaching is dedicated to helping individuals achieve personal and professional growth through tailored guidance, practical tools, and ongoing support. Your journey toward success starts with the right coach by your side.ro 
              </p>
